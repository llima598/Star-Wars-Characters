...
Catálogo interativo de personagens do universo Star Wars, desenvolvido para praticar **JavaScript, consumo de API e construção de interfaces responsivas**.
...
- Listagem de personagens consumida diretamente da API pública [SWAPI](https://swapi.info)
